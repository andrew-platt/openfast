...
IMPLICIT NONE
    ...
    INTEGER(IntKi), PUBLIC, PARAMETER  :: ModuleFF_LidSim = 5      ! LidarSim module for lidar [-]
! =========  Farm_ParameterType  =======
...
! 
 ...
 SUBROUTINE Farm_DestroyLidSim_Data( LidSim_DataData, ErrStat, ErrMsg )
...
! 
  ErrStat = ErrID_None
  ErrMsg  = ""
  CALL LidarSim_DestroyContState( LidSim_DataData%x, ErrStat, ErrMsg )
  CALL LidarSim_DestroyDiscState( LidSim_DataData%xd, ErrStat, ErrMsg )
...
DO i1 = LBOUND(All_FastFarm_DataData%LidSim,1), UBOUND(All_FastFarm_DataData%LidSim,1)
  CALL Farm_Destroylidsim_data( All_FastFarm_DataData%LidSim(i1), ErrStat, ErrMsg )
ENDDO
