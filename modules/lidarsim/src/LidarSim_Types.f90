...
! =========  LidarSim_OutputType  =======
  TYPE, PUBLIC :: LidarSim_OutputType
    ...
    TYPE(MeshType)  :: LidarVelVisMesh      !< Motion Mesh of all measurement points -- for visualization wind velocity [-]
...
! 
 ...
 SUBROUTINE LidarSim_DestroyInitInput( InitInputData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
ENDIF
 ...
 SUBROUTINE LidarSim_DestroyInitOutput( InitOutputData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
ENDIF
      CALL MeshCopy( SrcOutputData%LidarMeasMesh, DstOutputData%LidarMeasMesh, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
      CALL MeshCopy( SrcOutputData%LidarVelVisMesh, DstOutputData%LidarVelVisMesh, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
 END SUBROUTINE LidarSim_CopyOutput

 SUBROUTINE LidarSim_DestroyOutput( OutputData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
ENDIF
  CALL MeshDestroy( OutputData%LidarMeasMesh, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
  CALL MeshDestroy( OutputData%LidarVelVisMesh, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      IF(ALLOCATED(Int_Buf)) THEN ! LidarMeasMesh
         ...
         DEALLOCATE(Int_Buf)
      END IF
      Int_BufSz   = Int_BufSz + 3  ! LidarVelVisMesh: size of buffers for each call to pack subtype
      CALL MeshPack( InData%LidarVelVisMesh, Re_Buf, Db_Buf, Int_Buf, ErrStat2, ErrMsg2, .TRUE. ) ! LidarVelVisMesh 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN

      IF(ALLOCATED(Re_Buf)) THEN ! LidarVelVisMesh
         Re_BufSz  = Re_BufSz  + SIZE( Re_Buf  )
         DEALLOCATE(Re_Buf)
      END IF
      IF(ALLOCATED(Db_Buf)) THEN ! LidarVelVisMesh
         Db_BufSz  = Db_BufSz  + SIZE( Db_Buf  )
         DEALLOCATE(Db_Buf)
      END IF
      IF(ALLOCATED(Int_Buf)) THEN ! LidarVelVisMesh
         Int_BufSz = Int_BufSz + SIZE( Int_Buf )
         DEALLOCATE(Int_Buf)
      END IF
  IF ( Re_BufSz  .GT. 0 ) THEN 
  ...
  END IF
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
      CALL MeshPack( InData%LidarVelVisMesh, Re_Buf, Db_Buf, Int_Buf, ErrStat2, ErrMsg2, OnlySize ) ! LidarVelVisMesh 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
 ...
 ! buffers to store meshes, if any
  ...
  END IF
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL MeshUnpack( OutData%LidarVelVisMesh, Re_Buf, Db_Buf, Int_Buf, ErrStat2, ErrMsg2 ) ! LidarVelVisMesh 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
...
ENDIF
 ...
 SUBROUTINE LidarSim_DestroyParam( ParamData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
ENDIF
 ...
 SUBROUTINE LidarSim_DestroyInput( InputData, ErrStat, ErrMsg, DEALLOCATEpointers )
  ...
  CALL MeshDestroy( InputData%LidarMesh, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
...
ENDIF
 ...
 SUBROUTINE LidarSim_DestroyInputFile( InputFileData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
! 
 ...
 SUBROUTINE LidarSim_DestroyMisc( MiscData, ErrStat, ErrMsg, DEALLOCATEpointers )
  ...
  CALL NWTC_Library_Destroymeshmaptype( MiscData%u_L_p2p_y_Lmeas, ErrStat2, ErrMsg2, DEALLOCATEpointers_local )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
...
! 
 ...
 SUBROUTINE LidarSim_DestroyOtherState( OtherStateData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
! 
 ...
 SUBROUTINE LidarSim_DestroyContState( ContStateData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
! 
 ...
 SUBROUTINE LidarSim_DestroyDiscState( DiscStateData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
! 
 ...
 SUBROUTINE LidarSim_DestroyConstrState( ConstrStateData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
END IF ! check if allocated
      CALL MeshExtrapInterp1(y1%LidarMeasMesh, y2%LidarMeasMesh, tin, y_out%LidarMeasMesh, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL MeshExtrapInterp1(y1%LidarVelVisMesh, y2%LidarVelVisMesh, tin, y_out%LidarVelVisMesh, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
...
END IF ! check if allocated
      CALL MeshExtrapInterp2(y1%LidarMeasMesh, y2%LidarMeasMesh, y3%LidarMeasMesh, tin, y_out%LidarMeasMesh, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
      CALL MeshExtrapInterp2(y1%LidarVelVisMesh, y2%LidarVelVisMesh, y3%LidarVelVisMesh, tin, y_out%LidarVelVisMesh, tin_out, ErrStat2, ErrMsg2 )
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
