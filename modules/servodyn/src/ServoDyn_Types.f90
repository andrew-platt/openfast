...
ENDIF
 ...
 SUBROUTINE SrvD_DestroyLidarMeasType( LidarMeasTypeData, ErrStat, ErrMsg, DEALLOCATEpointers )
...
ENDIF
  CALL SrvD_Destroylidarmeastype( InputData%LidarMeas, ErrStat2, ErrMsg2, DEALLOCATEpointers_local )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
