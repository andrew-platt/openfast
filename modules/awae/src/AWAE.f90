...
!..................................................................................................................................
   ...
   if ( (InitInp%Ldr_NumPts > 0) .and. (InitInp%InputFileData%dt_low > 0.5_DbKi) ) then
      ErrStat2 = ErrID_Warn
      ErrMsg2  = 'WARNING: dt_low is too large for use with high resolution lidar measurements at the farm level. '// &
   ...
   allocate ( u%Ldr_MeasPos(3,p%Ldr_NumPts), STAT=ErrStat2 );  if (errStat2 /= 0) call SetErrStat ( ErrID_Fatal, 'Could not allocate memory for u%Ldr_MeasPos.', errStat, errMsg, RoutineName )
