...
!   p_FAST%CheckHSSBrTrqC = .false.
   ...
   IF ( p_FAST%CompLidar == Module_LidSim ) THEN
      ...
      elseif( p_FAST%LidarMountLocation == LidarMount_Ground ) then       ! use tower base reference
         Init%InData_LidSim%LidarRefPosition(1:3)        = Init%OutData_ED%TwrBaseRefPos
         Init%InData_LidSim%LidarRefOrientation(1:3,1:3) = Init%OutData_ED%TwrBaseRefOrient                    ! R8Ki
